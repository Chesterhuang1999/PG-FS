...
params = {"t_tol": 55.7, "t_r": 10.0, "strength_ratio": 0.9}
gates = {
...
device = SCQubits2(num_qubits)
device.load_circuit(circuit)
#device.plot_pulses(pulse_labels = [{"Y01":"Y01"},{"Y10":"Y10"},{"Y12":"Y12"},{"Y21":"Y21"},{"sx0":"sx0"},{"sz0":"sz0"},{"sx1":"sx1"},{"sz1":"sz1"},{"sz2":"sz2"}])
#plt.savefig("pulse_csign02.pdf")
# Dressed frame
